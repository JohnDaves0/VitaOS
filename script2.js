...
function startUp() {
    ...
    setTimeout(() => {
        booting[2].style.opacity = "1";
        booting[3].style.opacity = "1";
    }, 8000);
}
...
let help = [
    "VitaOS v1.0.2 Command Manual",
    "clear - clears all messages",
    "open - opens a file, for example: \"open readme.md\"",
    "cd - changes directory, for example: \"cd nodecom\"",
    "cd .. - navigates to the parent directory",
    "cd ~ - navigates to the home directory",
    "pwd - prints current working directory",
    "ls - lists all subdirectories and files",
    "joke - prints a joke",
    "knock knock - reveal it"
];
let isBooted = true;
let isFile = false;
let fileRequested = " ";
...
let jokes = [
    ...
    "I told my friend I didn't want to go skydiving because I'm afraid of heights. He said I shouldn't worry—most accidents happen on the ground.",
    "I bought a ceiling fan the other day. Complete waste of money. He just stands there, clapping.",
    "I have a step ladder because my real ladder left when I was young.",
    "My boss told me to have a good day... so I went home.",
    "I know a lot of jokes about retired people... but none of them work.",
    "I bought a belt from the store, but it didn't fit. What a waist!",
